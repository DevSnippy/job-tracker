// Mock data — Israeli tech jobs, techmap-style
const JOBS = [
...
const STAGES = ["Saved", "Interested", "Applied", "Interview", "Offer"];
...
window.JT_DATA = { JOBS, STATUS_CONFIG, STAGES, RESUMES, TEMPLATES, WEBHOOKS, EVENTS };
